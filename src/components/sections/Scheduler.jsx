      ...
      <div className="w-full max-w-full mx-auto">
        {hasCalendly ? (
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className={`text-center p-20 md:p-32 rounded-[3rem] ${
              isDark
          ...
          >
            <motion.div
              ...
              className="inline-flex items-center justify-center mt-5 w-32 h-32 md:w-40 md:h-40 rounded-full mb-10"
              style={{
            ...
            <h3 className="text-4xl md:text-7xl mt-10 font-bold font-display mb-8 leading-tight">
              Let's Find a <span className="gradient-text">Time to Chat</span>
            </h3>
            <p className={`text-xl md:text-2xl mb-14 mt-6 max-w-full mx-auto leading-relaxed ${isDark ? 'text-white/60' : 'text-gray-500'}`}>
              I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.
            </p>

            <div className="flex flex-col sm:flex-row items-center pt-5 justify-center gap-8 mt-10">
              <a
                href={`mailto:${personalInfo.email}?subject=Meeting Request`}
                className="px-10 py-6 md:px-14 md:py-8 rounded-full font-medium text-xl md:text-2xl text-white flex items-center gap-3 transition-all hover:shadow-[0_0_40px_rgba(99,102,241,0.5)]"
              ...
              <a
                ...
                className={`px-10 py-6 md:px-14 md:py-8 rounded-full font-medium text-xl md:text-2xl flex items-center gap-3 transition-all ${
                  isDark
