    ...
    <SectionWrapper id="about">
      ...
      <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center mb-20">
        ...
        >
          ...
          <p className={`text-base md:text-lg mb-5 leading-relaxed ${isDark ? 'text-white/70' : 'text-gray-600'}`}>
            {personalInfo.shortBio}
          </p>
          <p className={`text-base md:text-lg mb-8 leading-relaxed ${isDark ? 'text-white/60' : 'text-gray-500'}`}>
            {personalInfo.detailedBio}
          </p>
          <div className={`inline-flex items-center w-15 gap-5 text-sm px-8 py-5 rounded-full ${
      ...
      {/* Stats */}
      <div className="grid grid-cols-2 translate-y-15 md:grid-cols-3 gap-6 mb-20">
      ...
      {/* Tech Stack */}
      <div>
        <h3 className={`text-2xl lg:text-3xl font-bold translate-y-25 font-display text-center mb-10 ${isDark ? 'text-white/90' : 'text-gray-800'}`}>
          Technologies I Work With
        </h3>
        <div className="grid grid-cols-10 translate-y-25 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-20 xl:grid-cols-9 gap-8">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className={`group flex flex-col items-center translate-y-15 gap-3 p-4 rounded-2xl cursor-pointer transition-all duration-300 ${
                isDark
            ...
            >
              <skill.icon
                className="text-4xl md:text-5xl h-20 w-20 transition-all duration-300"
                style={{
